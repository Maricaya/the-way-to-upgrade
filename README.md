...
- [X] [Effectic Java](https://book.douban.com/subject/27047716/)
- [X] [Java并发编程实战](https://book.douban.com/subject/10484692/)(进行中，第8章)
...
- [X] [C10K问题](https://en.wikipedia.org/wiki/C10k_problem)
- [X] [Thousands of Threads and Blocking I/O](https://www.slideshare.net/e456/tyma-paulmultithreaded1)
- [X] [Scalable IO in Java - Doug Lea](http://gee.cs.oswego.edu/dl/cpjslides/nio.pdf)
